...
/** 
 * \fn extern u1 Random_GF2_m(pu1 v, u1 size)
...
/** 
 * \fn extern u1 Create_support_using_rng(pu4 pu4Support, u1 u1Rank)
...
**********************************************************************/
/** 
 * \fn extern u1 Create_gf2mn_using_support(pu4 pu4Element, pu4 pu4Support, u1 u1Rank)
 * \brief Generation of support with a given rank
 *
 * \param[out]     pu4Support : address of the support.
 * \param[in]          u1Rank : Dimmension of the support (= number of independent elements)
