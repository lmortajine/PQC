...
/** 
 * \fn extern u1 leading_coefficient_div(pu4 pu4R, pu4 pu4V, pu4 pu4U, u1 degree_v, u1 degree_u, pu4 workspace)
...
extern u1 leading_coefficient_div(pu4 pu4R, pu4 pu4V, pu4 pu4U, u1 degree_v, u1 degree_u, pu4 workspace)
{
...
/** 
 * \fn extern u1 mult_by_element(pu4 pu4R, pu4 pu4V, pu4 pu4scalar, u1 nb_coeff, pu4 workspace, u1 nb_shift)
...
**/
extern u1 mult_by_element(pu4 pu4R, pu4 pu4V, pu4 pu4scalar, u1 nb_coeff, pu4 workspace, u1 nb_shift)
{
...
/** 
 * \fn extern u1 shift_GF2mn(pu4 pu4X, u1 nb_shift, u1 nb_coeffX)
 * \brief  This function shifts an element of GF(2^m)^n.
 * \param[out]   pu4X : adress of the shifted polynomial.
 * \param[in]   nb_shift : number of shift to apply to the element pu4X.
 * \param[in]   nb_coeffX : number of coefficient in pu4X.
**/

extern u1 shift_GF2mn(pu4 pu4X, u1 nb_shift, u1 nb_coeffX)
{
  memcpy(pu4X + nb_shift * PARAM_M_LEN_WORD, pu4X, nb_coeffX*PARAM_M_LEN_WORD*4);
  memset(pu4X,0x00, nb_shift*PARAM_M_LEN_WORD*4);
  return 0;
}

/** 
 * \fn extern u1 init_modulo(pu4 pu4v, int n)
 * \brief  This function inits the modulo in memory
 * \param[out]   pu4v : address of the modulo.
 * \param[in]       n : degree of the modulo.
**/
extern u1 init_modulo(pu4 pu4v, int n)
{
  if(n==47)
  {
    *(pu4v) = 0x1;
...
/** 
 * \fn extern u1 modular_inverse_GF2mn(pu4 pu4R, pu4 pu4X, pu4 pu4modulo)
...
extern u1 modular_inverse_GF2mn(pu4 pu4R, pu4 pu4X, pu4 pu4modulo)
{
...
/** 
 * \fn extern u1 Degree_GF2mn(pu4 pu4Polynom, u1 u1CoeffLength, u1 u1DegreeMaxPolynom)
...
extern u1 Degree_GF2mn(pu4 pu4Polynom, u1 u1CoeffLength, u1 u1DegreeMaxPolynom)
{
...
/** 
 * \fn extern u1 Add_GF2mn(u1 u1NbCoeff, u1 u1CoeffLength, pu4 pu4X, pu4 pu4Y, pu4 pu4R)
...
extern u1 Add_GF2mn(u1 u1NbCoeff, u1 u1CoeffLength, pu4 pu4X, pu4 pu4Y, pu4 pu4R)
{
...
/** 
 * \fn extern u1 Mupliply_GF2mn(pu4 pu4X, pu4 pu4Y, pu4 pu4R, u1 u1NbCoeffX, u1 u1NbCoeffY, u1 u1ModuloDegree, u1 u1CoeffLength)
...
extern u1 Mupliply_GF2mn(pu4 pu4X, pu4 pu4Y, pu4 pu4R, u1 u1NbCoeffX, u1 u1NbCoeffY, u1 u1ModuloDegree, u1 u1CoeffLength)
{
    u1 u1i, u1j, u1k, u1l;
...
/** 
 * \fn extern u2 SchoolMultiply(pu4 pu4X, pu4 pu4Y, pu4 pu4R, u1 u1NbCoeffX, u1 u1NbCoeffY)
...
extern u2 SchoolMultiply(pu4 pu4X, pu4 pu4Y, pu4 pu4R, u1 u1NbCoeffX, u1 u1NbCoeffY)
{
    u1 u1i, u1j;
...
/** 
 * \fn extern u2 ModularReduction(pu4 pu4X, pu4 pu4R, u1 u1NbCoeffX, u1 u1ModuloDegree, u1 u1CoeffLength)
...
extern u2 ModularReduction(pu4 pu4X, u1 u1NbCoeffX, u1 u1ModuloDegree, u1 u1CoeffLength)
{
    u1 u1i;
...
/** 
 * \fn extern u2 Karatsuba(pu4 pu4X, pu4 pu4Y, pu4 pu4R, pu4 pu4Workspace, u1 u1Degree, u1 u1CoeffLength)
...
extern u2 Karatsuba(pu4 pu4X, pu4 pu4Y, pu4 pu4R, pu4 pu4Workspace, u1 u1Degree, u1 u1CoeffLength)
{
  u1 u1i;
...
/** 
 * \fn extern u1 Karatsuba_Degree(u1 u1Degree)
...
extern u1 Karatsuba_Degree(u1 u1Degree)
{
  switch(u1Degree) 
  {
    case 47 :
...
/** 
 * \fn extern u1 S_i_calculus(pu4 pu4F, pu4 pu4S, pu4 pu4R, u1 u1Index, u1 u1SDim)
...
extern u1 S_i_calculus(pu4 pu4F, pu4 pu4S, pu4 pu4R, u1 u1Index, u1 u1SDim)
{
...
/** 
 * \fn extern u1 Intersection(pu4 pu4V1, pu4 pu4V2, pu4 pu4Workspace, u1 u1Dim, u1 u1CoeffLength, u1 u1ModuloDegree)
...
extern u1 Intersection(pu4 pu4V1, pu4 pu4V2, pu4 pu4R, u1 pu4V1Dim, u1 pu4V2Dim, u1 u1CoeffLength)
{
...
/** 
 * \fn extern u2 PreCalculusRSR(pu4 pu4F, pu4 pu4S, pu4 pu4Workspace, pu1 u1TabDimInterSi)
...
extern u2 PreCalculusRSR(pu4 pu4F, pu4 pu4S, pu4 pu4Workspace, pu1 u1TabDimInterSi, u1 u1SDimMax)
{
  u1 u1i;
...
/** 
 * \fn extern u2 Rank_Support_Recover(pu4 E, pu4 pu4F, pu4 pu4Syndrom, pu4 pu4Workspace)
...
extern u2 Rank_Support_Recover(pu4 pu4E, pu4 pu4F, pu4 pu4Syndrom, pu4 pu4Workspace)
{
